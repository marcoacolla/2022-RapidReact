...
public class Controllers {
    ...
    public final JoystickButton lTrigger0 = new JoystickButton(xboxController0, XboxController.Button.kStickLeft.value);
    public final JoystickButton lBumper0 = new JoystickButton(xboxController0, XboxController.Button.kBumperLeft.value);
    public final JoystickButton rBumper0 = new JoystickButton(xboxController0, XboxController.Button.kBumperRight.value);
